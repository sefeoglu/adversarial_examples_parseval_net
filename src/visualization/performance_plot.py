...
for exp in Experiment:
    ...
    for file in  os.listdir(prefix+exp):
        ...
        if format == "h5":
            ...
            row = {"Model_ID":ModelID, "percent":percent,"epsilon":epsilon,"accuracy":acc[1],"attack":0}
    ...
    tab_25_001["mean_acc"], tab_25_001["mean_att"] = sum(tab_25_001["accuracy"])/10, sum(tab_25_001["attack"])/10
    tab_25_01 = tab_25[tab_25["epsilon"] =="0.01"]
    tab_25_01["mean_acc"], tab_25_01["mean_att"] = sum(tab_25_01["accuracy"])/10, sum(tab_25_01["attack"])/10
    tab_25_03 = tab_25[tab_25["epsilon"] =="0.03"]
    tab_25_03["mean_acc"], tab_25_03["mean_att"] = sum(tab_25_03["accuracy"])/10, sum(tab_25_03["attack"])/10
    tab_25_005 = tab_25[tab_25["epsilon"] =="0.005"]
    tab_25_005["mean_acc"], tab_25_005["mean_att"] = sum(tab_25_005["accuracy"])/10, sum(tab_25_005["attack"])/10
    tab_25_003 = tab_25[tab_25["epsilon"] =="0.003"]
    tab_25_003["mean_acc"], tab_25_003["mean_att"] = sum(tab_25_003["accuracy"])/10, sum(tab_25_003["attack"])/10

    tab_5_001 = tab_5[tab_5["epsilon"] =="0.001"]
    tab_5_001["mean_acc"], tab_5_001["mean_att"] = sum(tab_5_001["accuracy"])/10, sum(tab_5_001["attack"])/10
    tab_5_01 = tab_5[tab_5["epsilon"] =="0.01"]
    tab_5_01["mean_acc"], tab_5_01["mean_att"] = sum(tab_5_01["accuracy"])/10, sum(tab_5_01["attack"])/10

    tab_5_03 = tab_5[tab_5["epsilon"] =="0.03"]
    tab_5_03["mean_acc"], tab_5_03["mean_att"] = sum(tab_5_03["accuracy"])/10, sum(tab_5_03["attack"])/10
    tab_5_005 = tab_5[tab_5["epsilon"] =="0.005"]
    tab_5_005["mean_acc"], tab_5_005["mean_att"] = sum(tab_5_005["accuracy"])/10, sum(tab_5_005["attack"])/10
    tab_5_003 = tab_5[tab_5["epsilon"] =="0.003"]
    tab_5_003["mean_acc"], tab_5_003["mean_att"] = sum(tab_5_003["accuracy"])/10, sum(tab_5_003["attack"])/10
    tab_1_001 = tab_1[tab_1["epsilon"] =="0.001"]
    tab_1_001["mean_acc"], tab_1_001["mean_att"] = sum(tab_1_001["accuracy"])/10, sum(tab_1_001["attack"])/10
    tab_1_01 = tab_1[tab_1["epsilon"] =="0.01"]
    tab_1_01["mean_acc"], tab_1_01["mean_att"] = sum(tab_1_01["accuracy"])/10, sum(tab_1_01["attack"])/10
    tab_1_03 = tab_1[tab_1["epsilon"] =="0.03"]
    tab_1_03["mean_acc"], tab_1_03["mean_att"] = sum(tab_1_03["accuracy"])/10, sum(tab_1_03["attack"])/10
    tab_1_005 = tab_1[tab_1["epsilon"] =="0.005"]
    tab_1_005["mean_acc"], tab_1_005["mean_att"] = sum(tab_1_005["accuracy"])/10, sum(tab_1_005["attack"])/10
    tab_1_003 = tab_1[tab_1["epsilon"] =="0.003"]
    tab_1_003["mean_acc"], tab_1_003["mean_att"] = sum(tab_1_003["accuracy"])/10, sum(tab_1_003["attack"])/10


    tab_75_001 = tab_75[tab_75["epsilon"] =="0.001"]
    tab_75_001["mean_acc"], tab_75_001["mean_att"] = sum(tab_75_001["accuracy"])/10, sum(tab_75_001["attack"])/10
    tab_75_01 = tab_75[tab_75["epsilon"] =="0.01"]
    tab_75_01["mean_acc"], tab_75_01["mean_att"] = sum(tab_75_01["accuracy"])/10, sum(tab_75_01["attack"])/10
    tab_75_03 = tab_75[tab_75["epsilon"] =="0.03"]
    tab_75_03["mean_acc"], tab_75_03["mean_att"] = sum(tab_75_03["accuracy"])/10, sum(tab_75_03["attack"])/10
    tab_75_005 = tab_75[tab_75["epsilon"] =="0.005"]
    tab_75_005["mean_acc"], tab_75_005["mean_att"] = sum(tab_75_005["accuracy"])/10, sum(tab_75_005["attack"])/10
    tab_75_003 = tab_75[tab_75["epsilon"] =="0.003"]
    tab_75_003["mean_acc"], tab_75_003["mean_att"] = sum(tab_75_003["accuracy"])/10, sum(tab_75_003["attack"])/10
    ...
    print(table_mean[column].sort_values(by=["epsilon", "percent"]).to_latex(index=False))
